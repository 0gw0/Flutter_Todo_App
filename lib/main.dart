...
class _MyAppState extends State<MyApp> {
  ...
  Widget _buildListItem(BuildContext context, int index, TodoItem todoItem) {
    ...
    return ListTile(
      leading:
          Checkbox(value: todoItem.checked, onChanged: (_) => check(index)),
      trailing: IconButton(
        icon: Icon(Icons.delete, color: todoItem.checked ? color : dark),
